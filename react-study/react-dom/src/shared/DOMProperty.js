...
const illegalAttributeNameCache = {}; // 非法属性
...
// 这些是接受“true”和“false”的“枚举”HTML属性。
// 在React中，我们允许用户传递“true”和“false”，即使技术上这些属性不是布尔属性（它们被强制为字符串）。
...
// 这些是接受“true”和“false”的“枚举”SVG属性。
//在React中，我们允许用户传递'true'和'false'，尽管技术上是这样
//这些不是布尔属性（它们被强制为字符串）。
//因为这些是SVG属性，所以它们的属性名区分大小写。
[
  'autoReverse',
