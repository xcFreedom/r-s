...
export const REACT_CONCURRENT_MODE_TYPE = hasSymbol ? Symbol.for('react.concurrent_mode') : 0xead0;

export const REACT_FORWARD_REF_TYPE = hasSymbol ? Symbol.for('react.forward_ref') : 0xead1;

export const REACT_SUSPENSE_TYPE = hasSymbol ? Symbol.for('react.suspense') : 0xead2;

export const REACT_PROFILER_TYPE = hasSymbol ? Symbol.for('react.profiler') : 0xead3;

export const REACT_MEMO_TYPE = hasSymbol ? Symbol.for('react.memo') : 0xead4;

export const REACT_LAZY_TYPE = hasSymbol ? Symbol.for('react.lazy') : 0xead5;
